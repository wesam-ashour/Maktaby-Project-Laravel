...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="desktop-logo logo-light active" href="{{ url('/') }}"><img
                src="{{URL::asset('assets/img/logoo2.svg')}}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img
                src="{{URL::asset('assets/img/logoo2.svg')}}" class="main-logo dark-theme" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}"><img
                src="{{URL::asset('assets/img/logoo2.svg')}}" class="logo-icon" alt="logo"></a>
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                         src="/images/users/{{ Auth::user()->profile_photo_path }}"><span
        ...
        <ul class="side-menu">
            <li class="side-item tx-20 side-item-category">الرئيسية</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard') }}">
                    ...
                    <span class="side-menu__label">لوحة التحكم</span><span
                        class="badge badge-success side-badge"></span></a>
            </li>
            @can('الاقسام')
            <li class="side-item tx-20 side-item-category">الأقسام</li>
            @endcan
            @can('الشركات')
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='companies') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <span class="side-menu__label">الشركات</span></a>
            </li>
            @endcan
            @can('الاماكن للمستخدم')
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='user/places') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                        <path d="M5 5h15v3H5zm12 5h3v9h-3zm-7 0h5v9h-5zm-5 0h3v9H5z" opacity=".3"/>
                        <path
                    ...
                    <span class="side-menu__label">الاماكن</span></a>
            </li>
            @endcan
            @can('الخدمات للمستخدم')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الميّزات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='user/services') }}">عرض</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='add/services') }}">إضافة</a></li>
            ...
            @can('الملاحظات')
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='admin/feedback') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <span class="side-menu__label">الملاحظات</span></a>
            </li>
            @endcan
            <li class="side-item tx-20 side-item-category">الإعدادات</li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . $page='change/profile/information') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                        <
                        <path
                    ...
                    <span class="side-menu__label">الملف الشخصي</span></a>
            </li>
